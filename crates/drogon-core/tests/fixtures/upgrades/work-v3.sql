-- Recorded past schema: work component at v3 (sources beside Jira, before
-- the additive v4 auto-import column on work_boards). Carries an imported
-- board, a ticket and a turned-off source, so the v3->v4 step's "add a
-- column, touch nothing else" claim is proven against real prior data.
CREATE TABLE schema_versions (
    component TEXT PRIMARY KEY,
    version INTEGER NOT NULL
);
INSERT INTO schema_versions(component, version) VALUES ('work', 3);
