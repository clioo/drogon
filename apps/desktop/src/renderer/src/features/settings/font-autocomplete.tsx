...
//     (combobox with popover listbox, starts-with/contains filtering,
//      ArrowUp/Down + Enter + Escape keyboard contract, clear/toggle
//      buttons, hover/keyboard highlight preview callback)
// Adapted: suggestions/filter/render helpers come from this repo's
// terminal-typography.ts; copy strings are literals (no i18n catalog).
...
export function FontAutocomplete({
  ...
  const visibleSuggestions =
    !isFilteringQuery && normalizedQuery === normalizedValue
      ? suggestions
      : filteredSuggestions;
  ...
  const [prevVisibleSuggestions, setPrevVisibleSuggestions] =
