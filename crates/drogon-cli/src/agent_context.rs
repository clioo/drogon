    ...
    let mut commands = vec![
        ...
        entry(
            ...
            &[
                ...
                "The Return is delivered as its own keypress after the body (and, for a message-sized body sent to a TUI that asked for bracketed paste, after the paste end marker), so a paste-detecting TUI cannot swallow it mid-turn.",
