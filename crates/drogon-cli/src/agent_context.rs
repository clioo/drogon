...
pub fn all_commands() -> Vec<AgentCommand> {
    let mut commands = vec![
        ...
        entry(
            ...
            "drogon-cli environment list",
            &[],
            &[],
            &["drogon-cli environment list --json"],
            &["The native runtime has no pairing store, so the list is empty."],
        ),
        entry(
            "environment show",
            &["environment", "show"],
            "Show one saved environment",
            "drogon-cli environment show --environment <SELECTOR>",
            &["environment"],
            &[],
            &["drogon-cli environment show --environment prod --json"],
        ...
        entry(
            ...
            "drogon-cli environment rm --environment <SELECTOR>",
            &["environment"],
            &[],
            &["drogon-cli environment rm --environment prod --json"],
            &["Answers typed not_found: the native runtime stores no environments."],
        ),
        entry(
            "project setups",
        ...
        entry(
            ...
            "drogon-cli worktree list --project <ID> [--limit <N>]",
            &["limit", "project"],
            &[],
