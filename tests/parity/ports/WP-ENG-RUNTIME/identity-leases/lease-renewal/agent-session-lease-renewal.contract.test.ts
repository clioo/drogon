...
// Original: src/main/runtime/agent-session-lease-renewal.test.ts (SHA256 901b96b322a1f040fe6dd037fd4ab0d12de9b6210ba982485a4c3800155d530d).
import { mkdtemp, readFile, rm } from 'node:fs/promises'
import { tmpdir } from 'node:os'
import { join } from 'node:path'
import { afterEach, describe, expect, it } from 'vitest'
import type { AgentSessionRecord } from '../../../../../../apps/desktop/src/shared/agent-session-record'
import { AgentSessionRecordStore } from '../../../../../../apps/desktop/src/main/runtime/agent-session-record-store'
import { agentSessionStorePath } from '../../../../../../apps/desktop/src/main/runtime/agent-session-record-store-file'
