...
fn work_commands() -> Vec<AgentCommand> {
    ...
    vec![
        entry(
            "work board",
            &["work", "board"],
            "Show the Work board: columns in order with their tickets, linked sessions and prompt triggers",
            "drogon-cli work board [--project <PROJECT>]",
            &["project"],
            &[],
            &[
            ...
            &[REQUIRES, "--project accepts a project id or its name."],
        ),
        entry(
            "work column create",
            &["work", "column", "create"],
            "Add a column to the Work board",
            "drogon-cli work column create --name <NAME> [--icon <ICON>] [--index <N>]",
            &["icon", "index", "name"],
            &[],
        ...
        entry(
            ...
            "drogon-cli work column update --column <COLUMN> [--name <NAME>] [--icon <ICON>] [--index <N>] [--on-enter <true|false>] [--schedule <EVERY|CRON> | --no-schedule] [--pr-watch <true|false>] [--message <TEXT> | --message-file <PATH>] [--recipients <all|primary>] [--harness <HARNESS> | --default-harness]",
            &[
                "column",
                "default-harness",
                "harness",
            ...
            &[
                ...
                "Placeholders: {ticket.id} {ticket.title} {ticket.pr} {ticket.pr_number} {ticket.url} {ticket.description} {ticket.next} {ticket.project} {ticket.column}.",
        ...
        entry(
            ...
            "drogon-cli work ticket list [--column <COLUMN>] [--project <PROJECT>]",
            &["column", "project"],
            &[],
        ...
        entry(
            ...
            "drogon-cli work ticket move --ticket <TICKET> --column <COLUMN> [--index <N>]",
            &["column", "index", "ticket"],
            &[],
