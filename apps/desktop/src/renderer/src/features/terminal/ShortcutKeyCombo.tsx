...
// src/renderer/src/components/ShortcutKeyCombo.tsx. Adapted: the translate()
// call is inlined to its English default (Drogon has no i18n catalog); the
// KeyCap layout, separator rule and classes are verbatim.
