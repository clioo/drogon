...
//   src/renderer/src/components/browser-pane/assemble-chrome/browser-address-bar-expansion.test.ts
// Adapted: import path and formatting only; every case is the fork's.
