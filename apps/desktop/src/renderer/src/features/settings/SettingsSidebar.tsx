...
// Adapted: no zustand store, no repo/project groups, no setup-guide row —
// a controlled five-section nav over this repo's settings-sections; the
// ⌘F hint is a plain kbd pair (no ShortcutKeyCombo dependency).
