...
// Ported from orca-drogon: src/renderer/src/components/ui/dialog.tsx
// The source resolves the sr-only close label through
// translate('auto.components.ui.dialog.f26c4baeda', 'Close'); Drogon has no
// i18n layer, so the English literal is inlined.
"use client";
