-- Recorded past schema: work component at v2 (imported Jira boards, before
-- the additive v3 sources table). Carries an imported board with a ticket
-- and its activity, so the v2->v3 step's "add a table, touch nothing else"
-- claim is proven against real prior data.
CREATE TABLE schema_versions (
    component TEXT PRIMARY KEY,
    version INTEGER NOT NULL
);
INSERT INTO schema_versions(component, version) VALUES ('work', 2);
