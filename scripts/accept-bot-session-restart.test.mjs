// Pin test for the accept-bot-session-restart resync hunk.
//
...
// (`node scripts/accept-bot-session-restart.mjs`, background window, shell
...
const journey = readFileSync(
  path.join(
    ...
    "accept-bot-session-restart.mjs",
  ),
  "utf8",
);

describe("bot-session-restart placement resync", () => {
