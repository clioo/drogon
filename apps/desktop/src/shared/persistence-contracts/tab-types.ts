...
// c97906287bb7a390b25e2025b600d9fb3c25d9c3, src/shared/tab-types.ts
// (SHA256 52f7c9931a012a53be6c7a302c72fe8adc27570d48adf2e1f8dc7197c82faeba),
// declarations: TabGroupSplitDirection, TabGroupLayoutNode, TabContentType,
// WorkspaceVisibleTabType, Tab, TabGroup. Type-only extraction; the
// toVisibleTabType normalizer and CtrlTabOrderMode stay in the pinned source.
...
export type Tab = {
  ...
  /** Originating session identity for a native Mentu recipe tab. */
  mentuSessionId?: string
