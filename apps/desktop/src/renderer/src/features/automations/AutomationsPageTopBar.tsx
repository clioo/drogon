...
// omitted; the pageView-driven breadcrumb stays literal. The list heading
// is the source's bare single-row h1 (no subtitle); breadcrumb views render
// the source's single-row header.
...
export function AutomationsPageTopBar({
  ...
  return (
    <header
      className={cn("shrink-0 px-3 pb-3 md:px-5", "flex items-center")}
