...
// src/renderer/src/components/terminal-pane/terminal-link-pointer-gesture.ts.
...
export function installTerminalLinkPointerGesture(
  terminal: { hasSelection(): boolean; element?: HTMLElement | null },
): TerminalLinkPointerGesture {
