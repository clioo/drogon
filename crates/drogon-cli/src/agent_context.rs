...
fn work_commands() -> Vec<AgentCommand> {
    ...
    vec![
        ...
        entry(
            ...
            "drogon-cli work import preview --board <ID> [--scope <board|backlog|sprint:ID>] [--provider <PROVIDER>] [--site <SITE>]",
            &["board", "provider", "scope", "site"],
            &[],
            &["drogon-cli work import preview --board 7 --scope sprint:25 --json"],
            &[
                BOARDS,
                "Issues already on the Drogon board carry importedTicketId.",
            ],
        ),
        entry(
            "work import remove",
        ...
        entry(
            ...
            "drogon-cli work import run --board <ID> (--issue <KEY> ... | --all) [--project <PROJECT>] [--provider <PROVIDER>] [--site <SITE>]",
            &["all", "board", "issue", "project", "provider", "site"],
            &[],
            &[
