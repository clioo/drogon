...
// src/shared/workspace-cleanup-filter-model.ts
// (SHA256 f06aa15537ef2c4207ddf2e67ddfe7a840c275618d079cb2c58300d9eb429378),
// declarations: the cleanup facet unions and filter/sort state types.
// Type-only extraction; the default-state factories stay in the pinned source.
