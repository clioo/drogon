...
ticket", a ticket key such as "DRG-42" or an imported key such as "APP-128", "ENG-12" or
"owner/repo#12", "import a Jira/Linear/GitHub board", "push to Jira/Linear/GitHub",
"connect Linear", "carry over to the active sprint", "Drogon worktree", "child worktree",
