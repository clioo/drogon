...
// src/renderer/src/components/terminal-search-safe-find.test.ts (import path
// updated; the regression narrative for crash 0b9b636 is kept verbatim).
 ...
 * TerminalSearch effect, it trips the error boundary and kills the terminal surface.
 *
...
// decoration width.
const positiveIntegerError = (): Error =>
  new Error("This API only accepts positive integers");
