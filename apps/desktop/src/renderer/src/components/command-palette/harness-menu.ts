...
// opens the actual menu (New Terminal, per-harness immediate-launch rows,
// New Browser Tab), so the palette never reimplements or bypasses the
// menu launch and its recovery.
