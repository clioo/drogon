...
// src/renderer/src/components/automations/AutomationTimeField.tsx. Literal
// port (digit commit/step helpers, 12h clock with AM/PM, minute-only mode).
...
function TimeDigitInput({
  ...
  const [text, setText] = useState(pad ? pad2(value) : String(value));
        ...
        {mode === "time" ? (
          <>
            ...
            <button
              ...
              aria-label={`AM or PM: ${clock.period}`}
