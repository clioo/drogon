...
| R16-BG: estado de agente para Codex (working/needs_input/idle) vía CODEX_HOME gestionado por sesión, sin tocar ~/.codex; verificación con binario stub, sin inferencia pagada | R16 | luna | PR #313 abierto (estado de harness Codex aislado); gates pendientes | |
