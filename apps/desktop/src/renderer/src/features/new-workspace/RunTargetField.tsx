/* MIT Copyright (c) 2026 Lovecast Inc. Ported verbatim from Orca's
   src/renderer/src/components/new-workspace/RunTargetField.tsx (adapter: the
   source's i18n keys are inlined as their English literals — Drogon has no
   i18n layer; ExecutionHostId is a plain string here). */
      ...
      >
        ...
        <div className="relative min-w-0 flex-1 overflow-hidden">
          <input
            ...
            value={query}
            placeholder={committed ? "" : "Choose target"}
