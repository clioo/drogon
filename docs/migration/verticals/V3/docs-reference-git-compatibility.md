<!--
PROVENANCE: verbatim copy, no edits below the horizontal rule.
Source path: docs/reference/git-compatibility.md
Source repository: /Users/carlos/Documents/Drogon-mentu-session (read-only
migration reference, per AGENTS.md)
Source commit: c97906287bb7a390b25e2025b600d9fb3c25d9c3
Copied by: V3 git read-only process wrapper task (task_079044d59f7a),
2026-09-07, because git.rs / git_worktree.rs already cite this path as their
source of truth but the path did not exist in this checkout (gap flagged by
docs/migration/verticals/V3/git-readonly-wrapper-proposal.md, "Missing
source-of-truth doc"). This copy fills that gap; it is policy, not
implementation, and is not rewritten here.
-->
