...
// Verbatim: the framing escapes, output-tail mode observation, sanitization,
// newline normalization and the paste dispatch are the source's policy.
...
export function encodeWindowsInputRecordPasteText(
  ...
  const newlineSequence = newline === 'csi-u' ? '\u001b[13;2u' : '\u001b\r'
  let encoded = ''
