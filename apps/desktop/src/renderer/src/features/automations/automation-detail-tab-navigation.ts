...
// src/renderer/src/components/automations/automation-detail-tab-navigation.ts.
// Literal port; the tab union is the local Overview/Runs pair.
export type AutomationPaneTab = "overview" | "runs";

export type AutomationDetailTabArrowKey = "ArrowLeft" | "ArrowRight";

export function isAutomationDetailTabArrowKey(
  key: string,
): key is AutomationDetailTabArrowKey {
