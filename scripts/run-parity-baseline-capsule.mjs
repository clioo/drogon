...
export function stageCapsule({ manifestPath, sourceRoot, repoRoot = REPO_ROOT, label }) {
  ...
  writeFileSync(configPath, generatedVitestConfig(manifest.entryTestFile), { flag: "wx" });
...
export function executeCapsule({
  ...
  if (readFileSync(configPath, "utf8") !== generatedVitestConfig(receipt.entryTestFile)) {
