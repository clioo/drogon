// Provider marks for the sidebar Tasks nav chips (#346). This repo's
// lucide-react build no longer ships brand icons (same constraint as
// features/tasks/github-icon.tsx), so GitLab's lucide path (ISC-licensed,
// lucide v0.577.0) is inlined here; LinearIcon and JiraIcon are ported
// from Orca's src/renderer/src/components/icons/ (MIT Lovecast). Every
// mark consumes size/color via currentColor like a lucide icon.
import type { JSX } from "react";

export function GitlabIcon({ className }: { className?: string }): JSX.Element {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden
...
export function LinearIcon({ className }: { className?: string }): JSX.Element {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden
...
export function JiraIcon({ className }: { className?: string }): JSX.Element {
  return (
    <svg
